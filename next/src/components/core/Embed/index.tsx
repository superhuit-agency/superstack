...
function getEmbedUrl(rawUrl?: string, providerNameSlug?: string, type?: string): string | null {
...
export default function Embed({ providerNameSlug, url, caption, type }: EmbedProps) {
