...
const Image: FC<ImageProps> & BlockConfigs = forwardRef<HTMLImageElement, ImageProps>((
  {
    url,
    alt = '',
    height,
  ...
  const hasValidDimensions = Number.isFinite(normalizedWidth) && Number.isFinite(normalizedHeight);
