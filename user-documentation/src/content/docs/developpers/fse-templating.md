---
title: 'Templating FSE'
category: 'developpers'
subcategory: 'Architecture'
summary: 'Comment les templates WordPress Full Site Editing sont gérés côté headless (WordPress → Next.js).'
order: 1
---
